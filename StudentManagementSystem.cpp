...
/*
*From the Master C++ Programming from Beginner to Advance 2024.
*Use of repeating program.
*Use of classes, switch statement, functions outside the class, file I/O.
*/
