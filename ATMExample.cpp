...
/* Mini Project - ATM
   ...
   *From the Master c++ Programming From Beginner To Advance 2024 Edition.
   *Good example use of two do while loops to keep programming executing, showing two different interfaces.
   *Use of OOP programming.
   *Use of getter and setter methods.
   *Use of building a class.
   *Use of system exit functions.
