...
Program Description: A program that provides a great example of a student management system. Provides examples of input and output, OOP and using the command window to operate the program.
